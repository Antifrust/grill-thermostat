...
import static com.thermosatat.marcel.thermostat.Constants.SERVICE_STRING;
import static com.thermosatat.marcel.thermostat.Constants.CHARACTERISTIC_ECHO_STRING;
...
public class BluetoothUtils {
    ...
    public static List<BluetoothGattCharacteristic> findCharacteristics(BluetoothGatt bluetoothGatt) {
        ...
        for (BluetoothGattCharacteristic characteristic : characteristicList) {
            Log.d("Scherer","find characteristics: " + characteristic.getUuid().toString());
